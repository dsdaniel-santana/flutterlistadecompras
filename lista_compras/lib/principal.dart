...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> fetchData() async {
    try {
      final response = await http.get(
        Uri.parse('https://ideawebsites.com.br/api_compras/getdata.php'),
      );
  ...
  Future<void> updateRecord(String id) async {
    try {
      final response = await http.post(
        Uri.parse('https://ideawebsites.com.br/api_compras/updatedata.php'),
        body: {
          'id': id,
  ...
  Future<void> addRecord(String produto, String qtde) async {
    try {
      final response = await http.post(
        Uri.parse('https://ideawebsites.com.br/api_compras/adddata.php'),
        body: {
          'produto': produto,
          'qtde': qtde,
        },
  ...
  Future<void> editRecord(String id, String produto, String qtde) async {
    try {
      final response = await http.post(
        Uri.parse('https://ideawebsites.com.br/api_compras/editdata.php'),
        body: {
          'id': id,
          'produto': produto,
          'qtde': qtde,
    ...
    if (confirm == true) {
      try {
        final response = await http.delete(
          Uri.parse('https://ideawebsites.com.br/api_compras/deleteall.php'),
        );
